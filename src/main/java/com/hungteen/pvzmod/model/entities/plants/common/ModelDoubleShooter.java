...
public class ModelDoubleShooter extends ModelBase {
	...
	public ModelDoubleShooter() {
		...
		head.cubeList.add(new ModelBox(head, 116, 46, -1.0F, -3.0F, 8.0F, 2, 1, 4, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 5, 39, -2.0F, -4.0F, 12.0F, 4, 5, 2, 0.0F, false));
