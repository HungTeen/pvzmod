...
public class ModelPeaShooterZombie extends ModelBase {
	...
	public ModelPeaShooterZombie() {
		...
		head.cubeList.add(new ModelBox(head, 228, 243, -5.0F, -12.0F, 7.0F, 10, 10, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 198, 202, -7.0F, -14.0F, -7.0F, 14, 14, 14, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 230, 168, 7.0F, -12.0F, -5.0F, 1, 10, 10, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 234, 137, -8.0F, -12.0F, -5.0F, 1, 10, 10, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 208, 251, -1.0F, -11.0F, 8.0F, 2, 1, 4, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 158, 245, -5.0F, -15.0F, -5.0F, 10, 1, 10, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 137, 240, -2.0F, -12.0F, 12.0F, 4, 5, 2, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 80, 227, -4.0F, -11.0F, -21.0F, 8, 8, 14, 0.0F, false));
	}
