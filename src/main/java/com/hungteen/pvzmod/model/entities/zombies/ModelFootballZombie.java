...
public class ModelFootballZombie extends ModelBase {
	...
	public ModelFootballZombie() {
		...
		left_arm.cubeList.add(new ModelBox(left_arm, 3, 214, 0.0F, 0.0F, -5.0F, 20, 1, 10, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 60, 197, 2.0F, -1.0F, -5.0F, 8, 1, 10, 0.0F, false));
		...
		right_arm.cubeList.add(new ModelBox(right_arm, 4, 143, 0.0F, 0.0F, -5.0F, 20, 1, 10, 0.0F, false));
		...
		bone2.cubeList.add(new ModelBox(bone2, 63, 127, 2.0F, -1.0F, -5.0F, 8, 1, 10, 0.0F, false));
