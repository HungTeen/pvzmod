package com.hungteen.pvzmod.model.entities.zombies.normal;
...
public class ModelNormalZombie extends ModelBase {
	...
	public ModelNormalZombie() {
		textureWidth = 256;
		textureHeight = 256;

		left_leg = new ModelRenderer(this);
		left_leg.setRotationPoint(4.0F, 0.0F, 1.0F);
		left_leg.cubeList.add(new ModelBox(left_leg, 0, 0, -4.0F, 0.0F, -5.0F, 8, 24, 8, 0.0F, false));
		...
		body.cubeList.add(new ModelBox(body, 0, 41, -8.0F, -24.0F, 0.0F, 16, 24, 8, 0.0F, false));
		...
		head.cubeList.add(new ModelBox(head, 16, 96, -8.0F, -16.0F, -9.0F, 16, 16, 16, 0.0F, false));
	}
