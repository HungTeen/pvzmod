...
public class ModelPaperZombie extends ModelBase {
	...
	public ModelPaperZombie() {
		...
		bone2.cubeList.add(new ModelBox(bone2, 88, 212, 0.0F, -2.0F, -13.0F, 1, 16, 25, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 5, 174, -1.0F, -2.0F, -13.0F, 1, 15, 25, 0.0F, false));

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -24.0F, 0.0F);
		head.cubeList.add(new ModelBox(head, 66, 182, -7.0F, -14.0F, -7.0F, 14, 14, 14, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 130, 207, -7.0F, -15.0F, 2.0F, 13, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 169, 208, -6.0F, -15.0F, -3.0F, 13, 1, 1, 0.0F, false));
