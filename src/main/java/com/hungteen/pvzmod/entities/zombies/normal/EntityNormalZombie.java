...
public class EntityNormalZombie extends EntityZombieBase {
	...
	public EntityNormalZombie(World worldIn) {
		...
		if(this.getZombieType()==Type.BEARD){
			this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(EntityUtil.ZOMBIE_BEARD_DAMAGE);
		}
	}
	...
	protected Type getType() {
		...
		if(t==0) return Type.BEARD;
		else if(t<=2) return Type.SUPER;
