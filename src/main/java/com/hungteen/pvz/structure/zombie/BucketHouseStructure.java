...
public class BucketHouseStructure extends ScatteredStructure<NoFeatureConfig>{
	...
	protected int getBiomeFeatureDistance(ChunkGenerator<?> chunkGenerator) {
		return PVZConfig.COMMON_CONFIG.WORLD_SETTINGS.overWorldSettings.BucketHouseDistance.get();
	}
	
	@Override
	protected int getBiomeFeatureSeparation(ChunkGenerator<?> chunkGenerator) {
		return PVZConfig.COMMON_CONFIG.WORLD_SETTINGS.overWorldSettings.BucketHouseDistance.get()/4;
	}
