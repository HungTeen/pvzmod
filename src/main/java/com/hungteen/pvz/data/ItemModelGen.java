...
public class ItemModelGen extends ItemModelProvider {
    ...
    protected void registerModels() {
        /* these spawn egg don't use default spawn egg template */
        final Set<Item> BAN_SPAWN_EGG = new HashSet<>(Arrays.asList(
                PVZItems.COPPER_COIN_SPAWN_EGG.get(), PVZItems.SILVER_COIN_SPAWN_EGG.get(), PVZItems.GOLD_COIN_SPAWN_EGG.get()
        ));
