	...
	public void accept(BiConsumer<ResourceLocation, Builder> t) {
		...
		t.accept(PVZLoot.BUCKET_HOUSE_CHEST, LootTable.lootTable()
				.withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.PEA_SHOOTER_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SUN_FLOWER_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.CHERRY_BOMB_ENJOY_CARD.get()).setWeight(21).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.WALL_NUT_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.SNOW_PEA_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.CHOMPER_ENJOY_CARD.get()).setWeight(12).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.REPEATER_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomly.randomApplicableEnchantment()))
						.add(ItemLootEntry.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
						.add(ItemLootEntry.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
						.add(EmptyLootEntry.emptyItem().setWeight(15)))
		...
		t.accept(PVZLoot.DOLPHIN_HOUSE_CHEST, LootTable.lootTable()
				.withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
						...
						.add(ItemLootEntry.lootTableItem(Items.SPIDER_EYE).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 3.0F))))
						.add(ItemLootEntry.lootTableItem(Items.ROTTEN_FLESH).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(3.0F, 7.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.LILY_PAD_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SQUASH_ENJOY_CARD.get()).setWeight(21).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.THREE_PEATER_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.TANGLE_KELP_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.JALAPENO_ENJOY_CARD.get()).setWeight(12).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SPIKE_WEED_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.TORCH_WOOD_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.TALL_NUT_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomly.randomApplicableEnchantment()))
						.add(ItemLootEntry.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
						.add(ItemLootEntry.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
						.add(EmptyLootEntry.emptyItem().setWeight(15)))
		...
		t.accept(PVZLoot.GRAVE_YARD_CHEST, LootTable.lootTable()
				.withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
						...
						.add(ItemLootEntry.lootTableItem(Items.SPIDER_EYE).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 3.0F))))
						.add(ItemLootEntry.lootTableItem(Items.ROTTEN_FLESH).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(3.0F, 7.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.PUFF_SHROOM_ENJOY_CARD.get()).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SUN_SHROOM_ENJOY_CARD.get()).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.FUME_SHROOM_ENJOY_CARD.get()).setWeight(20).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.HYPNO_SHROOM_ENJOY_CARD.get()).setWeight(6).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SCAREDY_SHROOM_ENJOY_CARD.get()).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.DOOM_SHROOM_ENJOY_CARD.get()).setWeight(20).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
		...
		t.accept(PVZLoot.YETI_HOUSE_CHEST, LootTable.lootTable()
				.withPool(LootPool.lootPool().setRolls(RandomValueRange.between(2.0F, 4.0F))
						...
						.add(ItemLootEntry.lootTableItem(Items.SPIDER_EYE).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 3.0F))))
						.add(ItemLootEntry.lootTableItem(Items.ROTTEN_FLESH).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(3.0F, 7.0F))))
						.add(ItemLootEntry.lootTableItem(ItemRegister.SEA_SHROOM_ENJOY_CARD.get()).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.STAR_FRUIT_ENJOY_CARD.get()).setWeight(15).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						...
						.add(ItemLootEntry.lootTableItem(ItemRegister.MAGNET_SHROOM_ENJOY_CARD.get()).setWeight(20).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(Items.WITHER_ROSE).setWeight(2).apply(SetCount.setCount(RandomValueRange.between(1.0F, 2.0F))))
						.add(ItemLootEntry.lootTableItem(Items.BOOK).setWeight(20).apply(EnchantRandomly.randomApplicableEnchantment()))
						.add(ItemLootEntry.lootTableItem(Items.GOLDEN_APPLE).setWeight(20))
						.add(ItemLootEntry.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2))
