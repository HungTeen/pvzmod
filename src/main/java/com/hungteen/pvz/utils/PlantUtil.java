...
public class PlantUtil {
	...
	static {
		...
		putPlantInfoToMap(Plants.CABBAGE_PULT, 100, CDs.HUGE_FAST, Ranks.GRAY, Essences.ARMA, EntityRegister.CABBAGE_PULT, ItemRegister.CABBAGE_PULT_CARD, ItemRegister.CABBAGE_PULT_ENJOY_CARD);
