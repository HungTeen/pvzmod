...
public class MariGoldModel extends EntityModel<MariGoldEntity> {
	...
	public MariGoldModel() {
		...
		head.setTextureOffset(0, 123).addBox(-5.0F, 5.95F, -5.99F, 10.0F, 1.0F, 4.0F, -0.02F, false);
		head.setTextureOffset(85, 100).addBox(-1.5F, -0.25F, -6.25F, 3.0F, 2.0F, 1.0F, -0.25F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-4.2776F, -11.4466F, -5.75F);
		head.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.0F, -0.3054F);
		cube_r1.setTextureOffset(107, 88).addBox(-3.5F, -1.0F, -0.5F, 7.0F, 2.0F, 1.0F, -0.25F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(5.5F, -12.25F, -6.25F);
		head.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, 0.3054F);
		cube_r2.setTextureOffset(106, 94).addBox(-4.0F, 0.0F, 0.0F, 7.0F, 2.0F, 1.0F, -0.25F, false);

		HUABAN = new ModelRenderer(this);
		HUABAN.setRotationPoint(0.0F, -3.0F, 1.0F);
		head.addChild(HUABAN);
		setRotationAngle(HUABAN, 0.0F, 0.0F, -0.2618F);
		HUABAN.setTextureOffset(0, 62).addBox(-3.0F, -18.0F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN.setTextureOffset(29, 63).addBox(-3.0F, 9.8564F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN.setTextureOffset(42, 36).addBox(10.9282F, -4.0718F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN.setTextureOffset(73, 73).addBox(-16.9282F, -4.0718F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		...
		HUABAN2.setTextureOffset(0, 62).addBox(-2.4641F, -17.8564F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN2.setTextureOffset(29, 63).addBox(-2.4641F, 10.0F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN2.setTextureOffset(42, 36).addBox(11.4641F, -3.9282F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN2.setTextureOffset(73, 73).addBox(-16.3923F, -3.9282F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		...
		HUABAN3.setTextureOffset(0, 62).addBox(-2.0718F, -17.4641F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN3.setTextureOffset(29, 63).addBox(-2.0718F, 10.3923F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN3.setTextureOffset(42, 36).addBox(11.8564F, -3.5359F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		HUABAN3.setTextureOffset(73, 73).addBox(-16.0F, -3.5359F, -7.1F, 6.0F, 6.0F, 4.0F, -0.5F, false);
		...
		cube_r3.setRotationPoint(0.0F, -34.7071F, -0.1213F);
		body.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.7854F, 0.0F, 0.0F);
		cube_r3.setTextureOffset(23, 0).addBox(-2.0F, -4.0F, -3.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
	...
	@Override
	public void setRotationAngles(MariGoldEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
	}
