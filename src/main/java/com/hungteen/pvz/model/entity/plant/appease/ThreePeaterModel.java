...
public class ThreePeaterModel extends EntityModel<ThreePeaterEntity> {
	...
	public ThreePeaterModel() {
		...
		up.addChild(body);
		body.setTextureOffset(45, 47).addBox(-1.0F, -15.0F, -1.0F, 2.0F, 15.0F, 2.0F, 0.0F, false);

		head = new ModelRenderer(this);
		head.setRotationPoint(0.7071F, -15.7071F, 0.0F);
		up.addChild(head);
		...
		head.setTextureOffset(46, 38).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		...
		up2.setRotationPoint(0.0F, 0.0F, 0.0F);
		total.addChild(up2);
		...
		up2.addChild(body2);
		body2.setTextureOffset(55, 45).addBox(0.0F, -1.0F, -1.0F, 2.0F, 17.0F, 2.0F, 0.0F, false);

		head2 = new ModelRenderer(this);
		head2.setRotationPoint(0.0F, -18.0F, 0.0F);
		up2.addChild(head2);
		head2.setTextureOffset(38, 15).addBox(-2.0F, -4.0F, -7.0F, 4.0F, 4.0F, 2.0F, 0.0F, false);
		head2.setTextureOffset(1, 19).addBox(-1.0F, -3.0F, -5.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		head2.setTextureOffset(0, 1).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		head2.setTextureOffset(46, 38).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, -7.0F, 4.0F);
		head2.addChild(bone4);
		setRotationAngle(bone4, 0.6109F, 0.6981F, 0.0F);
		bone4.setTextureOffset(3, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(0.0F, 0.8192F, 0.4264F);
		bone4.addChild(bone5);
		setRotationAngle(bone5, -0.48F, 0.0F, 0.0F);
		bone5.setTextureOffset(54, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone6 = new ModelRenderer(this);
		bone6.setRotationPoint(0.0F, 0.0F, 2.0F);
		bone5.addChild(bone6);
		setRotationAngle(bone6, 0.3927F, 0.0F, 0.0F);
		bone6.setTextureOffset(33, 57).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);

		bone10 = new ModelRenderer(this);
		bone10.setRotationPoint(0.0F, -7.0F, 4.0F);
		head2.addChild(bone10);
		setRotationAngle(bone10, 0.6109F, -0.6981F, 0.0F);
		bone10.setTextureOffset(3, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone11 = new ModelRenderer(this);
		bone11.setRotationPoint(0.0F, 0.8192F, 0.4264F);
		bone10.addChild(bone11);
		setRotationAngle(bone11, -0.48F, 0.0F, 0.0F);
		bone11.setTextureOffset(54, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone12 = new ModelRenderer(this);
		bone12.setRotationPoint(0.0F, 0.0F, 2.0F);
		bone11.addChild(bone12);
		setRotationAngle(bone12, 0.3927F, 0.0F, 0.0F);
		bone12.setTextureOffset(33, 57).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);

		up3 = new ModelRenderer(this);
		up3.setRotationPoint(0.0F, 0.0F, 0.0F);
		total.addChild(up3);
		setRotationAngle(up3, 0.0F, 0.0F, 0.7854F);
		

		body3 = new ModelRenderer(this);
		body3.setRotationPoint(-1.0F, -13.0F, 0.0F);
		up3.addChild(body3);
		body3.setTextureOffset(34, 38).addBox(0.0F, -3.0F, -1.0F, 2.0F, 15.0F, 2.0F, 0.0F, false);

		head3 = new ModelRenderer(this);
		head3.setRotationPoint(-0.7071F, -15.7071F, 0.0F);
		up3.addChild(head3);
		setRotationAngle(head3, 0.0F, 0.0F, -0.7854F);
		head3.setTextureOffset(38, 15).addBox(-2.0F, -4.0F, -7.0F, 4.0F, 4.0F, 2.0F, 0.0F, false);
		head3.setTextureOffset(1, 19).addBox(-1.0F, -3.0F, -5.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		head3.setTextureOffset(0, 1).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		head3.setTextureOffset(46, 38).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);

		bone7 = new ModelRenderer(this);
		bone7.setRotationPoint(0.0F, -7.0F, 4.0F);
		head3.addChild(bone7);
		setRotationAngle(bone7, 0.6109F, 0.7418F, 0.0F);
		bone7.setTextureOffset(3, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone8 = new ModelRenderer(this);
		bone8.setRotationPoint(0.0F, 0.8192F, 0.4264F);
		bone7.addChild(bone8);
		setRotationAngle(bone8, -0.48F, 0.0F, 0.0F);
		bone8.setTextureOffset(54, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone9 = new ModelRenderer(this);
		bone9.setRotationPoint(0.0F, 0.0F, 2.0F);
		bone8.addChild(bone9);
		setRotationAngle(bone9, 0.3927F, 0.0F, 0.0F);
		bone9.setTextureOffset(33, 57).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);

		bone13 = new ModelRenderer(this);
		bone13.setRotationPoint(0.0F, -7.0F, 4.0F);
		head3.addChild(bone13);
		setRotationAngle(bone13, 0.6109F, -0.6981F, 0.0F);
		bone13.setTextureOffset(3, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone14 = new ModelRenderer(this);
		bone14.setRotationPoint(0.0F, 0.8192F, 0.4264F);
		bone13.addChild(bone14);
		setRotationAngle(bone14, -0.48F, 0.0F, 0.0F);
		bone14.setTextureOffset(54, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone15 = new ModelRenderer(this);
		bone15.setRotationPoint(0.0F, 0.0F, 2.0F);
		bone14.addChild(bone15);
		setRotationAngle(bone15, 0.3927F, 0.0F, 0.0F);
		bone15.setTextureOffset(33, 57).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);

		bone16 = new ModelRenderer(this);
		bone16.setRotationPoint(0.0F, -7.0F, 4.0F);
		head3.addChild(bone16);
		setRotationAngle(bone16, -0.2182F, 0.0F, 0.0F);
		bone16.setTextureOffset(3, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone17 = new ModelRenderer(this);
		bone17.setRotationPoint(0.0F, 0.8192F, 0.4264F);
		bone16.addChild(bone17);
		setRotationAngle(bone17, -0.7854F, 0.0F, 0.0F);
		bone17.setTextureOffset(54, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

		bone18 = new ModelRenderer(this);
		bone18.setRotationPoint(0.0F, 0.0F, 2.0F);
		bone17.addChild(bone18);
		setRotationAngle(bone18, 1.309F, 0.0F, 0.0F);
		bone18.setTextureOffset(33, 57).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);
	}

	@Override
	public void setRotationAngles(ThreePeaterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
