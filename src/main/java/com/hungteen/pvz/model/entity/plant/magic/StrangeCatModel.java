...
public class StrangeCatModel extends EntityModel<StrangeCatEntity> {
	...
	public StrangeCatModel() {
		...
		tail.setRotationPoint(0.0F, -24.8669F, 35.9447F);
		total.addChild(tail);
		...
		tail2.setTextureOffset(304, 323).addBox(-5.32F, -29.2438F, -2.3326F, 8.0F, 32.0F, 8.0F, 0.0F, false);
		...
		tail6.setTextureOffset(475, 226).addBox(-1.3606F, -6.0881F, -6.206F, 8.0F, 8.0F, 8.0F, 0.0F, false);
	}
