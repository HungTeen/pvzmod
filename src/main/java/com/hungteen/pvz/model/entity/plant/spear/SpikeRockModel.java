...
public class SpikeRockModel extends EntityModel<SpikeRockEntity> {
	...
	public SpikeRockModel() {
		...
		spike15.setTextureOffset(90, 72).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike14.setTextureOffset(105, 72).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike13.setTextureOffset(118, 74).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike12.setTextureOffset(75, 81).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike11.setTextureOffset(85, 81).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike10.setTextureOffset(95, 80).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike9.setTextureOffset(106, 80).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike8.setTextureOffset(117, 81).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike7.setTextureOffset(76, 88).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike6.setTextureOffset(75, 96).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike5.setTextureOffset(87, 89).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		spike4.setTextureOffset(86, 96).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
	}

	@Override
	public void setRotationAngles(SpikeRockEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		this.t2.showModel = (entity.getSpikeNum() * 1F / entity.getSpikesCount() > 2F / 3);
		this.t3.showModel = (entity.getSpikeNum() * 1F / entity.getSpikesCount() > 1F / 3);
		this.t1.showModel = (entity.getSpikeNum() * 1F / entity.getSpikesCount() > 0);
		int tot = entity.getAttackCD();
		int now = tot - entity.getAttackTime();
		this.t3.rotateAngleZ = AnimationUtil.getUpDown(now, tot, 25);
		this.t2.rotateAngleZ = AnimationUtil.getUpDown(now, tot, - 25);
		this.t1.rotateAngleX = AnimationUtil.getUpDownUpDown(now, tot, 25);
	}
