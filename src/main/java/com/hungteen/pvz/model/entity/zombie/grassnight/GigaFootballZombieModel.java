...
public class GigaFootballZombieModel extends EntityModel<GigaFootballZombieEntity> {
	...
	public GigaFootballZombieModel() {
		...
		left_arm.setTextureOffset(3, 214).addBox(0.0F, 0.0F, -5.0F, 21.0F, 1.0F, 10.0F, 0.0F, false);
		...
		left_arm.setTextureOffset(70, 76).addBox(5.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		left_arm.setTextureOffset(120, 64).addBox(10.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		left_arm.setTextureOffset(99, 52).addBox(15.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		right_arm.setTextureOffset(4, 143).addBox(0.0F, 0.0F, -5.0F, 21.0F, 1.0F, 10.0F, 0.0F, false);
		...
		right_arm.setTextureOffset(72, 46).addBox(5.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		right_arm.setTextureOffset(49, 58).addBox(10.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		right_arm.setTextureOffset(36, 80).addBox(15.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setRotationAngles(GigaFootballZombieEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		if(entity.getAttackTime() == 0) {
			this.up.rotateAngleX = 0.5f;
			this.head.rotateAngleX = - 0.5f;
			this.head.rotateAngleY = 0f;
			this.right_arm.rotateAngleX = 0.5f;
			this.left_arm.rotateAngleX = - 0.5f;
		} else {
			this.up.rotateAngleX = 0f;
