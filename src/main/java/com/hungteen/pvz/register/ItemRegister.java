...
import com.hungteen.pvz.item.tool.TargetArrowItem;
...
public class ItemRegister {
    ...
    public static final RegistryObject<PlantCardItem> UMBRELLA_LEAF_CARD = registerCard(Plants.UMBRELLA_LEAF, false);
    public static final RegistryObject<PlantCardItem> UMBRELLA_LEAF_ENJOY_CARD = registerCard(Plants.UMBRELLA_LEAF, true);
    ...
    public static final RegistryObject<PlantCardItem> MELON_PULT_CARD = registerCard(Plants.MELON_PULT, false);
    public static final RegistryObject<PlantCardItem> MELON_PULT_ENJOY_CARD = registerCard(Plants.MELON_PULT, true);
    ...
    public static final RegistryObject<PlantCardItem> EXPLODE_O_NUT_CARD = registerCard(Plants.EXPLODE_O_NUT, false);
    ...
    public static final RegistryObject<PlantCardItem> BONK_CHOY_CARD = registerCard(Plants.BONK_CHOY, false);
    public static final RegistryObject<PlantCardItem> BONK_CHOY_ENJOY_CARD = registerCard(Plants.BONK_CHOY, true);
