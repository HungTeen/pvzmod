...
public class GigaArmorModel extends BipedModel<LivingEntity> {
	...
	public GigaArmorModel(EquipmentSlotType slot, float scale) {
		...
		chestplate.setPos(0.0F, 12.0F, 0.0F);
		...
		right_hand_armor.setPos(-1.0F, 0.0F, 0.0F);
		...
		right_hand_armor.texOffs(44, 51).addBox(-4.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		right_hand_armor.texOffs(44, 52).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		right_hand_armor.texOffs(45, 46).addBox(-1.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		right_hand_armor.texOffs(46, 53).addBox(-1.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		left_hand_armor.setPos(1.0F, 0.0F, 0.0F);
		...
		left_hand_armor.texOffs(44, 51).addBox(0.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		left_hand_armor.texOffs(44, 52).addBox(0.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		left_hand_armor.texOffs(45, 46).addBox(3.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		left_hand_armor.texOffs(46, 53).addBox(3.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
