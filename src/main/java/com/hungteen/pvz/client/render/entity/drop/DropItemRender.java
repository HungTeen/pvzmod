 ...
 **/
public class DropItemRender extends EntityRenderer<PVZDrop> {
    ...
    @Override
    public void render(PVZDrop dropEntity, float yaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferSource, int packedLightIn) {
    ...
    public ResourceLocation getTextureLocation(PVZDrop p_115034_) {
