...
public class PVZOverlayHandler {
    ...
    private static final ResourceLocation RESOURCE = Util.prefix("textures/gui/overlay/resources.png");
    private static final ResourceLocation FOG = Util.prefix("textures/gui/overlay/fog.png");
    private static final ResourceLocation INVASION = Util.prefix("textures/gui/overlay/invasion.png");
    private static final ResourceLocation TARGET = Util.prefix("textures/gui/overlay/target.png");
    ...
    public static void renderResources(PoseStack stack, int width, int height) {
        ...
        } else if(pos == 2 && PVZConfig.renderGemBar()) {
            renderGemBar(stack, width, height);
        } else if(pos == 3 && PVZConfig.renderTreeLevel()) {
...
//    }
    ...
    private static void renderSunBar(PoseStack stack, int width, int height) {
        ...
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95 + 1, 5 + 1, 6698496, 1.5f);
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95, 5, Colors.WHITE, 1.5f);
    ...
    public static void renderMoneyBar(PoseStack stack, int width, int height) {
        ...
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95 + 1, 5 + 1, 3610880, 1.5f);
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95, 5, Colors.WHITE, 1.5f);
    ...
    public static void renderGemBar(PoseStack stack, int width, int height) {
        ...
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95 + 1, 5, 46545, 1.5f);
        RenderUtil.drawCenteredScaledString(stack, ClientProxy.MC.font, now + "", 95, 5, Colors.WHITE, 1.5f);
