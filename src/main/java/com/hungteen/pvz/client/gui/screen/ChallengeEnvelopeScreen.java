...
public class ChallengeEnvelopeScreen extends Screen{
	...
	private final Optional<IChallengeComponent> challengeComponent;
	
	public ChallengeEnvelopeScreen(ItemStack envelope) {
		super(new TranslationTextComponent("gui.pvz.challenge_envelope"));
		this.challengeComponent = ChallengeEnvelopeItem.getRaidComponent(envelope);
	}
	...
	public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
		...
		this.challengeComponent.ifPresent(challengeComponent -> {
