...
import com.hungteen.pvz.model.armor.ConeHeadModel;
...
public class ConeArmorItem extends ArmorItem{
	...
	public ConeArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot) {
		super(materialIn, slot, new Item.Properties().group(GroupRegister.PVZ_GROUP));
	}
	...
	{
		modelMap.put(EquipmentSlotType.HEAD, new ConeHeadModel(1f));
	}
}
